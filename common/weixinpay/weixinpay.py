...
MAIN_DOMAIN = 'http://www.84che.com'
...
if __name__ == '__main__':
    weixinpay = Weixinpay()
    # print weixinpay.get_prepay_id(body=u"巴适二手车", out_trade_no="W2014120815441258305", total_fee=2000, openid="oNYsJj1eg4fnU4tKLvH-f2IXlxJ4")
