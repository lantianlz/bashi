...
dict_weixin_app = {
    'bashi_test': {'app_id': 'wx0d227d4f9b19658a', 'app_secret': '513bdaf5b6022df4913f4cb5543fa688', 'app_type': 'gh_65671b9fff9d',
                   'token': 'bashi_test', 'url': ''},
    'bashi': {'app_id': 'wx23cca542b396c669', 'app_secret': 'dd8cc9591fa32514eed8876e652e6260', 'app_type': 'gh_de7e674b94d4',
              'token': 'bashi', 'url': ''},
}
...
class WexinBase(object):
    ...
    def init_app_key(self, default_value="bashi"):
        return "bashi_test" if settings.LOCAL_FLAG else default_value
    ...
    def get_subscribe_event_response(self, to_user, from_user):
        content = (u'我们已经恭候您多时了！洗车的时候能想到巴适二手车，人家真是幸福呢...\n'
                   u'巴适二手车是专属于年轻人的洗车平台，汇聚你身边的洗车行，为你提供最优惠、最便捷、最时尚的洗车服务\n'
                   u'洗车用巴适二手车，就对了！'
                   )
        ...
        if events:
            ...
            if event in ('subscribe',):
                ...
                img_info = u'[{"title": "洗车之前，看看咋用", "description": "%s", "url": "%s", "picurl": "%s"}]' \
                    % (content, url, 'http://static.84che.com/img/using_guide.jpg')
