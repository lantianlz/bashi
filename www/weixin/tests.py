...
def main():
    ...
    print async_send_email("web@84che.com", u'来自巴适二手车', utils.render_email_template('email/reset_password.html', context), 'html')

    # pprint(wb.get_user_info(app_key, to_user))
    # pprint(wb.get_qr_code_ticket(app_key))
    # pprint(wb.send_buy_success_template_msg(to_user, name=u"巴适二手车行洗车码", remark=u"洗车码1: 0098 6543 1221   洗车码2: 7788 9954 1432", app_key=app_key))
    # pprint(wb.send_use_order_code_template_msg(to_user, product_type=u"消费项目", name=u"巴适二手车行", time=u"2013年8月20日 20:38",
