...
SERVER_NAME = 'BASHI_WEB0' if not LOCAL_FLAG else 'DEVELOPER'
SERVER_DOMAIN = '84che.com' if not LOCAL_FLAG else '192.168.0.199:8002'
MAIN_DOMAIN = ('http://www.%s' % SERVER_DOMAIN) if not LOCAL_FLAG else ('http://%s' % SERVER_DOMAIN)

IMG0_DOMAIN = 'http://img0.84che.com'

EMAIL_FROM = u'"巴适二手车" <service@aoaoxc.com>'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'www_bashi',                      # Or path to database file if using sqlite3.
    ...
    'account': {
        'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'account_bashi',                      # Or path to database file if using sqlite3.
        'USER': DB_USER,                      # Not used with sqlite3.
        'PASSWORD': DB_PWD,                  # Not used with sqlite3.
        'HOST': DB_HOST,                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
...
# SESSION_COOKIE_DOMAIN = '.84che.com' if not LOCAL_FLAG else '.a.com'
SESSION_COOKIE_NAME = 'sessionid_bashi'
